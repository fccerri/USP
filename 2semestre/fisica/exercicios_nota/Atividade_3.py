...
'''
Atividade 3: Adicionar Função de Fechar Janela no Jogo da Cobrinha
    Aluno: Felipe Camargo Cerri
    Numero USP: 15451119
    23/11/2024
'''

#Chamada adicionada na main com base na pressao da tecla "ESC"
def fechar_janela(void):
    """
    A função fecha a janela do jogo quando chamada
    """
    pygame.quit()
    sys.exit()
